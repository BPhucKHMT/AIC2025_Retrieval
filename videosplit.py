...
if __name__ == '__main__':
    obj = VideoSplit()
    tag_based_result = obj.generate_tag_based(n=4)
    with open('video_division_tag.json', 'w', encoding='utf-8') as f:
        import json
        json.dump(tag_based_result, f, ensure_ascii=False, indent=4)